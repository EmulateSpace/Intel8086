...
emu8086-dirs	:= $(objs-y) $(libs-y)
emu8086-objs	:= $(patsubst %,%/built-in.o, $(objs-y))
emu8086-libs	:= $(patsubst %,%/lib.a, $(libs-y))
emu8086-all	:= $(emu8086-objs) $(emu8086-libs)

# Do modpost on a prelinked vmlinux. The finally linked vmlinux has
# relevant sections renamed as per the linker script.
quiet_cmd_emu8086 = LD      $@
      cmd_emu8086 = $(CC) $(KBUILD_CFLAGS) -o $@                          \
      -Wl,--start-group $(emu8086-libs) $(emu8086-objs) -Wl,--end-group

emu8086: $(emu8086-all)
	$(call if_changed,emu8086)

# The actual objects are generated when descending, 
# make sure no implicit rule kicks in
$(sort $(emu8086-all)): $(emu8086-dirs) ;
...
clean-dirs      := $(addprefix _clean_, $(emu8086-dirs))
